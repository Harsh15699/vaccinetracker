...
?>
    ...
    <script>
        var a =Number("<?php echo($_SESSION['pincode'])?>");
    ...
    if(rowCount<=1){
        document.getElementById("warning").innerHTML="Currently there are no slots available at your given pincode with your preffered choice";}
        ...
        "</audio>";              //alert(sessionStorage.getItem("number"));
    }
}
</script>
